...
import { requestWithoutAction } from "@/common/XHRClient";

export function doUpload(params: any, url: string,store: Store<any, AnyAction>) {
    const config = {
        method: 'post',
        url: url,
...
export function getDownloadFileUrl(fid: string,bgColor: string,store: Store<any, AnyAction>) {
...
export function downloadZipFile(params: URLSearchParams): Promise<any> {
...
export function clearPhoto(store: Store<any, AnyAction>) {
